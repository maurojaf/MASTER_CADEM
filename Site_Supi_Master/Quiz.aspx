        ...
        <div id="cuerpo" style="width:100%">
            <center>  
                <div style="width:70%; height:320px" class="divcuerpo">                                                         
                    <br />
                    <asp:Label ID="Label1" runat="server" class="neon-text" Text="Exportar datos Quiz"  ></asp:Label><br /> <br />
                    <center>             
                        <table width="50%" cellspacing="0">  
                            ...
                            <tr> 
                                <td> <div class="textonaranjo">Auditor</div> </td> 
                            ...
                            <tr>
                                <td colspan="2" align="center">  
                                    <asp:Button ID="btn_revisar_quiz" runat="server" Text="Revisar" CssClass="button-enjoy" TabIndex="8" onclick="btn_revisar_quiz_Click"   />  
                ...
                <div style="width:70%">
                      <asp:GridView ID="dgw_quiz" runat="server" BackColor="White"  
